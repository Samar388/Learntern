...
export default function DiscussionPage() {
  ...
  const discussionId = Number(params.moduleID);
      ...
      <main className="flex-1 flex flex-col">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-medium text-xs text-black">
                      ...
                      {msg.user.role === "Mentor" && (
                        <span className="ml-2 px-2 py-0.5 rounded bg-blue-100 text-blue-700 text-[10px] font-semibold align-middle">
                          [Mentor]
                        </span>
                      )}
                    </span>
        ...
        <footer className="px-6 py-4 border-t border-gray-300 bg-white">
          <div className="flex gap-2">
            ...
            <button
              onClick={handleSend}
              className="bg-black text-sm hover:bg-gray-800 text-white px-4 py-2 rounded-lg font-medium transition disabled:opacity-60"
              disabled={sending}
            >
